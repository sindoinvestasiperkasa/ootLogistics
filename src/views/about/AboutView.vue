<template>
    ...
    <!-- breadcrumb start -->
    <div class="breadcrumb-area bg-overlay-2" style="background-image:url('/assets/img/banner/breadcrumb1.png')">
        <div class="container">
            <div class="row">
                <div class="col-12">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6 order-lg-2">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="thumb">
                                <img class="w-100" src="/assets/img/about/5a.png" alt="img">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="thumb img-2">
                                <img class="w-100" src="/assets/img/about/6a.png" alt="img">
                            </div>
                        </div>
                    </div>                    
                </div>
    ...
    <div class="video-area pd-top-120 pd-bottom-120" style="background: #080C24;">
        <div class="video-thumb-wrap">
            <img src="/assets/img/video/1v.png" alt="img">
