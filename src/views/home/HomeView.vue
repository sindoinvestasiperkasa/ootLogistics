<template>
                    ...
                    <div class="col-lg-10 col-md-9 text-md-start text-center">
                        <ul class="topbar-left">
                            <li><svg width="12" height="17" viewBox="0 0 12 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                Kec Tarumajaya, Kab Bekasi 17211</li>
                            ...
                            <div class="section-title mb-0">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-6 col-lg-12 col-md-6 align-self-center">
                                        <div class="thumb"><img src="/assets/img/about/q.png" alt="img"></div>
                                    </div>
                                </div>
                                <div class="btn-wrap">
                                    <a class="btn btn-base" href="/about">ABOUT MORE</a>
                                    <div class="author-wrap">
                                        <div class="thumb"><img src="/assets/img/about/e.png" alt="img"></div>
                                        <div class="details">
    ...
    <!--wcu-area start-->
    <div class="wcu-area bg-overlay" style="background: url(/assets/img/wcu/bg1.png);">
            ...
            <div class="row justify-content-center">
                <div class="col-xl-7 col-lg-6 order-lg-2">
                    <div class="video-thumb-wrap">
                        <img src="/assets/img/wcu/video1.png" alt="img">
                    ...
                    <div class="team-slider owl-carousel">
                        <div class="item">
                            <div class="single-team-wrap">
                                <div class="thumb">
                                    <img src="/assets/img/team/1a.png" alt="img">
                                </div>
                                <div class="details">
                        ...
                        <div class="item">
                            <div class="single-team-wrap">
                                <div class="thumb">
                                    <img src="/assets/img/team/2a.png" alt="img">
                                </div>
                                <div class="details">
                        ...
                        <div class="item">
                            <div class="single-team-wrap">
                                <div class="thumb">
                                    <img src="/assets/img/team/3a.png" alt="img">
                                </div>
                                <div class="details">
                                    <h5>MISHEL MARSH</h5>
                                    <p>Co-Founder</p>
    ...
    <div class="call-to-contact-area pd-top-240" style="background: #F9F9F9;">
        <img src="/assets/img/contact/1q.png" alt="img">
        <div class="container">
    ...
    <div class="portfolio-area pd-top-115" style="background: url(/assets/img/portfolio/bg.png);">
        <div class="container">
            ...
            <div class="swiper-container">
                ...
                <div class="swiper-button-prev button"><img src="/assets/img/icon/left-arrow.png" alt="img"></div>
                <div class="swiper-button-next button"><img src="/assets/img/icon/right-arrow.png" alt="img"></div>            
            </div>
        </div>
    </div>
    <!-- portfolio area end -->
    ...
    <div class="partner-area pd-top-90 pd-bottom-120">
        <div class="container">
            ...
            <div class="partner-slider owl-carousel">
                <div class="item">
                    <div class="thumb">
                        <img src="/assets/img/partner/1c.png" alt="img">
                    </div>
                </div>
                <div class="item">
                    <div class="thumb">
                        <img src="/assets/img/partner/2c.png" alt="img">
                    </div>
                </div>
                <div class="item">
                    <div class="thumb">
                        <img src="/assets/img/partner/3c.png" alt="img">
                    </div>
                </div>
                <div class="item">
                    <div class="thumb">
                        <img src="/assets/img/partner/4c.png" alt="img">
                    </div>
                </div>
                <div class="item">
                    <div class="thumb">
                        <img src="/assets/img/partner/5c.png" alt="img">
                    </div>
                </div>
                <div class="item">
                    <div class="thumb">
                        <img src="/assets/img/partner/6c.png" alt="img">
                    </div>
                </div>
            </div> 
        </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-footer-top">
                            ...
                            <div class="details">
                                ...
                                <p>Kawasan Industri & Pergabungan Marunda Center,
                                Blok Q2 No.3A,5,6 Kel Segaramakmur, Kec Tarumajaya, Kab Bekasi 17211</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
            ...
            <div class="row">
                <div class="col-lg-6 text-lg-start text-center">
                    <div class="copyright-area">
                        <p>© Copyright 2025  By <a href="#">TransPro</a>, All right reserved.</p>
                    </div>
                </div>
